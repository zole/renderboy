var renderboy = new Renderboy04Filled();

function render() {
	renderboy.render();
}
	
function Renderboy04Filled() {
	this.fps = 30;
...
Renderboy04Filled.prototype.render = function() {
	...
	for (var i = 0; i < this.model.faces.length; i++) {
		...
		//this.drawPoly(poly, 0, 255, 0);
		this.drawFilledPoly(poly, 160, 64, 32);
		//break;
/*		
...
Renderboy04Filled.prototype.projectVertex = function(vertex) {
	return {
...
Renderboy04Filled.prototype.setPoint = function(x, y, r, g, b) {
	if (x < 0 || y < 0) {
		return;
	}
...
Renderboy04Filled.prototype._drawWideLine = function(x0, y0, deltaX, deltaY, xDir) {
...
// draw a line where ABS(deltaX) >= deltaY
Renderboy04Filled.prototype._drawTallLine = function(x0, y0, deltaX, deltaY, xDir) {
...
Renderboy04Filled.prototype.drawLine = function(x0, y0, x1, y1) {
	if (y0 > y1) {
...
Renderboy04Filled.prototype.drawPoly = function(vertices) {
...
Renderboy04Filled.prototype.drawFilledPoly = function(vertices, red, green, blue) {
...
Renderboy04Filled.prototype._scanEdge = function(point1, point2, edgeObj, subtract) {
